...
build_time_vars = {
    ...
    "PROFILE_TASK": "-m test --pgo -j 16 --ignore test_json --ignore test.test_bytes.BytesTest.test_from_format",
    ...
    "PYTHONPATH": "",
    "PYTHON_FOR_BUILD": "_PYTHON_PROJECT_BASE=/build/Python-3.14.4 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_x86_64-linux-gnu _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /build/Python-3.14.4/`cat pybuilddir.txt`) /tools/host/bin/python3.14",
    ...
    "RESSRCDIR": "",
    "RETSIGTYPE": "void",
    "RUNSHARED": "LD_LIBRARY_PATH=/build/Python-3.14.4",
    ...
    "TESTOPTS": "",
    "TESTPATH": "",
    "TESTPYTHON": "LD_LIBRARY_PATH=/build/Python-3.14.4 _PYTHON_PROJECT_BASE=/build/Python-3.14.4 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_x86_64-linux-gnu _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /build/Python-3.14.4/`cat pybuilddir.txt`) /tools/host/bin/python3.14",
    "TESTPYTHONOPTS": "",
    "TESTRUNNER": "LD_LIBRARY_PATH=/build/Python-3.14.4 _PYTHON_PROJECT_BASE=/build/Python-3.14.4 _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__linux_x86_64-linux-gnu _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /build/Python-3.14.4/`cat pybuilddir.txt`) /tools/host/bin/python3.14 -m test",
    ...
    "abs_builddir": "/build/Python-3.14.4",
    "abs_srcdir": "/build/Python-3.14.4",
